...
func TestPerformanceRegression(t *testing.T) {
	...
	t.Run("EqualPerformance", func(t *testing.T) {
		...
		assert.True(nanosPerOp < 10).
			True(elapsed < 100*time.Millisecond)
...
// ExamplePerformanceTesting demonstrates how to use benchmarks effectively
...
func TestPerformanceMonitoring(t *testing.T) {
	...
	t.Run("OperationTiming", func(t *testing.T) {
		...
		assert.WithinDuration(time.Now(), start.Add(maxDuration), maxDuration)
